...
String str1 = new String(bytes);                      // 将bytes按照系统默认编码格式(GBK)解码,产生Unicode字符

String str2= new String(bytes,"ISO-8859-1");          // 将bytes按照ISO-8859-1解码，产生Unicode字符

System.out.println(str1);                             // 中1  将Unicode字符转换为GBK编码输出
